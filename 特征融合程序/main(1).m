...
netconfig.inputsize=size(trainData_original,1);
...
% subplot(2,2,1)
% plot(PredTestOriginal,'r*')
% hold on
% plot(testLabel+0.01,'bo')
% xlabel('sample')
% ylabel('category label');
% h=legend('fault diagnosis label','Actual label ');
% set(h,'Fontsize',5,'Location','NorthWest');%% 同频率不同幅值
% xlabel('sample')
% ylabel('category label');
%% 
Add_Original_Data21()
load testData_original1
load testData_slope1
load testData_curvature1
load testLabel
cData{1}=testData_original1;
cData{2}=testData_slope1;
cData{3}=testData_curvature1;
 disp('在线预测......'); 
        load netconfig
        load parameter
        featureFusion =cell(3,1);
        ...
        probability=softmaxPara{1}*featureFusion{1}+softmaxPara{2}*featureFusion{2}+...
            softmaxPara{3}*featureFusion{3};
        [~, PredTestOriginal1] = max(probability);
        accTestOriginal = mean(testLabel(:) == PredTestOriginal1(:));
        fprintf('测试数据分类正确率: %0.2f%%\n',accTestOriginal * 100);
 %
 Add_Original_Data22()
load testData_original2
load testData_slope2
load testData_curvature2
load testLabel
cData{1}=testData_original2;
cData{2}=testData_slope2;
cData{3}=testData_curvature2;
 disp('在线预测......'); 
        load netconfig
        load parameter
        featureFusion =cell(3,1);
        ...
        probability=softmaxPara{1}*featureFusion{1}+softmaxPara{2}*featureFusion{2}+...
            softmaxPara{3}*featureFusion{3};
        [~, PredTestOriginal2] = max(probability);
        accTestOriginal = mean(testLabel(:) == PredTestOriginal2(:));
        fprintf('测试数据分类正确率: %0.2f%%\n',accTestOriginal * 100);
Add_Original_Data23()
load testData_original3
load testData_slope3
load testData_curvature3
load testLabel
cData{1}=testData_original3;
cData{2}=testData_slope3;
cData{3}=testData_curvature3;
 disp('在线预测......'); 
        load netconfig
        load parameter
        featureFusion =cell(3,1);
        ...
        probability=softmaxPara{1}*featureFusion{1}+softmaxPara{2}*featureFusion{2}+...
            softmaxPara{3}*featureFusion{3};
        [~, PredTestOriginal3] = max(probability);
        accTestOriginal = mean(testLabel(:) == PredTestOriginal3(:));
        fprintf('测试数据分类正确率: %0.2f%%\n',accTestOriginal * 100);
        %画图
sizefont=1;
subplot(2,2,1)
...
set(h,'Fontsize',5,'Location','NorthWest');
subplot(2,2,2)
plot(PredTestOriginal1,'r*')
hold on
plot(testLabel+0.01,'bo')
xlabel('sample')
ylabel('category label');
...
xlabel('sample')
ylabel('category label');
% title('Case Western Reserve University Bearing Center')
%画图
% sizefont=1;
% subplot(2,2,1)
% plot(PredTestOriginal,'r*')
...
% %% 
% Add_Original_Data41()
% load testData_original41
% load testData_slope41
% load testData_curvature41
% load testLabel
% cData{1}=testData_original41;
% cData{2}=testData_slope41;
% cData{3}=testData_curvature41;
%  disp('在线预测......'); 
%         load netconfig
%         load parameter
%         featureFusion =cell(3,1);
...
%         probability=softmaxPara{1}*featureFusion{1}+softmaxPara{2}*featureFusion{2}+...
%             softmaxPara{3}*featureFusion{3};
%         [~, PredTestOriginal41] = max(probability);
%         accTestOriginal = mean(testLabel(:) == PredTestOriginal41(:));
%         fprintf('测试数据分类正确率: %0.2f%%\n',accTestOriginal * 100);
%  %
%  Add_Original_Data42()
% load testData_original42
% load testData_slope42
% load testData_curvature42
% load testLabel
% cData{1}=testData_original42;
% cData{2}=testData_slope42;
% cData{3}=testData_curvature42;
%  disp('在线预测......'); 
%         load netconfig
%         load parameter
%         featureFusion =cell(3,1);
...
%         probability=softmaxPara{1}*featureFusion{1}+softmaxPara{2}*featureFusion{2}+...
%             softmaxPara{3}*featureFusion{3};
%         [~, PredTestOriginal42] = max(probability);
%         accTestOriginal = mean(testLabel(:) == PredTestOriginal42(:));
%         fprintf('测试数据分类正确率: %0.2f%%\n',accTestOriginal * 100);
% Add_Original_Data43()
% load testData_original43
% load testData_slope43
% load testData_curvature43
% load testLabel
% cData{1}=testData_original43;
% cData{2}=testData_slope43;
% cData{3}=testData_curvature43;
%  disp('在线预测......'); 
%         load netconfig
%         load parameter
%         featureFusion =cell(3,1);
...
%         probability=softmaxPara{1}*featureFusion{1}+softmaxPara{2}*featureFusion{2}+...
%             softmaxPara{3}*featureFusion{3};
%         [~, PredTestOriginal43] = max(probability);
%         accTestOriginal = mean(testLabel(:) == PredTestOriginal43(:));
%         fprintf('测试数据分类正确率: %0.2f%%\n',accTestOriginal * 100);
% %画图
% sizefont=1;
% subplot(2,2,1)
