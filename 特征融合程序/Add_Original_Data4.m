function Add_Original_Data4() %添加数据
clc
close all
clear all
xzb=2;%高斯白噪声的信噪比
...
x2=awgn(y2,xzb); 
Fault2=reshape(x2,columns,rows);
testData_original=[Fault1,Fault2];
...
Fault2_slope=reshape(x2_slope,columns,rows);
testData_slope=[Fault1_slope,Fault2_slope];
...
testData_curvature=[Fault1_curvature,Fault2_curvature];
