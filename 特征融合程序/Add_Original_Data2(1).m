...
%% 原始数据
%故障1
x1=1*sin(x)+ 0.2*rand(1,len);
Fault1=reshape(x1,columns,rows);
%故障2
x2=3*sin(8*x)+ 1*rand(1,len);
Fault2=reshape(x2,columns,rows);
%故障3
x3=2*sin(8*x)+ 0.4*rand(1,len);
Fault3=reshape(x3,columns,rows);
%故障4
x4=3*sin(16*x)+ 0.8*rand(1,len);
...
%% 原始数据
%故障1
x1=1*sin(x)+ 0.6*rand(1,len);
Fault1=reshape(x1,columns,rows);
%故障2
x2=3*sin(9*x)+ 0.9*rand(1,len);
Fault2=reshape(x2,columns,rows);
%故障3
x3=2*sin(8*x)+ 0.5*rand(1,len);
Fault3=reshape(x3,columns,rows);
%故障4
x4=2.6*sin(16*x)+ 0.9*rand(1,len);
Fault4=reshape(x4,columns,rows);
